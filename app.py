...
if market_file:
    ...
    # Extract table and plot
    market_file.seek(0)  # Reset file pointer
    ...
    if df_market is not None:
        ...
        st.info("No table detected in Market Access document.")
...
if yield_file:
    ...
    # Extract table and plot
    yield_file.seek(0)  # Reset file pointer
    ...
    if df_yield is not None:
        ...
        st.info("No table detected in Agricultural Yield document.")
